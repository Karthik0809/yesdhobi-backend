...
One API + realtime server for all four Yes Dhobi frontends.
...
| 3 | Vendor web registration (React) | `jagadeesh3344/yes-dhobi` | works **without code changes** (same URL + payload) → §3.4 |
